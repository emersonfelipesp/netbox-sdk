# netbox_tui/themes — JSON Theme Files — AGENTS.md Mirror
...
This file lives at `/root/personal-context/nmulticloud-context/netbox-sdk/netbox_tui/themes/CLAUDE.md` inside the `personal-context` workspace.
