...
from .cli_completions import CliCommandNode, nbx_root_command_nodes
from .state import TuiState, load_tui_state, save_tui_state
...
def _nbx_cli_execute(argv: list[str]) -> tuple[int, str]:
    ...
    from netbox_cli.cli import app  # noqa: PLC0415
