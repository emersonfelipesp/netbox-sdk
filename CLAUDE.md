...
- **Always** consult both design references before making any visual or styling changes:
  ...
  - `./reference/textual/TOAD-DESIGN-GUIDE.md` — Toad is the most advanced idiomatic Textual app and defines the Textual visual language (TCSS patterns, spacing, borders, states, animations). Use where NETBOX-DARK-PATTERNS.md has no opinion.
- Key rules:
