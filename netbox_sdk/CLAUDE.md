...
- RPC contract changes must update the fixed collection/action oracle, every semantic method transport assertion, the dedicated English/Portuguese SDK and CLI guides, and both root agent mirrors. Preserve confirmation-before-client behavior in the CLI and finite positive polling bounds.
