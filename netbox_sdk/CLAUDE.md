...
- `netbox_sdk.plugins` — immutable official-plugin registry. Only `netbox-rpc` and `netbox-proxbox` are first-class; other plugins remain reachable through runtime discovery when standard REST is sufficient.
