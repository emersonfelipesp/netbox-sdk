...
- `netbox_sdk.rpc` — fixed eight-collection netbox-rpc contract, policy-correct CRUD, every custom REST action, and bounded execution polling. Generic discovery cannot infer custom actions.
