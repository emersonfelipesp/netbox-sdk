...
`PluginsApp.branching` is wired for every bundled release line — 4.3, 4.4, 4.5, 4.6, and 4.7. Only 4.4 ships the fully typed wrapper; the other lines expose the dict-based `RawBranchingApp`.
