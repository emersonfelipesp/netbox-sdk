...
The typed client supports the stable NetBox release lines `4.7`, `4.6`, `4.5`, `4.4`, and `4.3`. Generated
models for those release lines are committed in the repository and shipped
with the package. The CI live-NetBox suite exercises `v4.7.0`, `v4.6.6`,
