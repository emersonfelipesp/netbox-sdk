...
| Compatibilidade NetBox | Linhas de SDK tipado para NetBox `4.6`, `4.5`, `4.4` e `4.3`, além de `4.7` (preview, opcional) |
| Validação live NetBox | A CI executa testes live do SDK contra NetBox `v4.7.0-beta2`, `v4.6.6`, `v4.6.3`, `v4.6.2` e `v4.5.10`; toda linha integrada, inclusive `4.7`, também executa um job dedicado com o esquema fixado |
