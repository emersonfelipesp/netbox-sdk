...
| Validação live NetBox | A CI executa testes live do SDK contra NetBox `v4.6.6`, `v4.6.3`, `v4.6.2` e `v4.5.10`; toda linha integrada, inclusive `4.7`, também executa um job dedicado com o esquema fixado |
