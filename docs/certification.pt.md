...
| --- | --- | --- | --- |
| candidato de código-fonte `0.0.13rc1` | `>=3.11,<3.14` | `4.7`, `4.6`, `4.5`, `4.4`, `4.3` | `v4.7.0`, `v4.6.6`, `v4.6.3`, `v4.6.2`, `v4.5.10`; um job com schema integrado por linha de release |
